...
io.on('connection', function(clientSocket){
 ...
 clientSocket.on("paymentSuccessFlag", function(isSuccess){
    console.log("payment is successfull " + isSuccess);
         var userInfo = {};
         userInfo["id"] = clientSocket.id;
         userInfo["isPaymentSuccessfull"] = isSuccess
     io.emit("getPaymentSuccessUpdate", userInfo);
  });
